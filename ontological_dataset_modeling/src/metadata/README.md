 ...
 * [imt.yml](imt.yml)
     * Determines how your purl.obolibrary.org/obo/imt/ redirects will be handled
     ...
     * Paste in the contents of [imt.yml](imt.yml)
 ...
 * [imt.md](imt.md)
     ...
     * Paste in the contents of [imt.md](imt.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
